...
find public/assets/config.jsx public/assets/shared public/assets/components public/assets/start.jsx | grep '.jsx' | while read file; do cat $file >> public/main.js; done;
